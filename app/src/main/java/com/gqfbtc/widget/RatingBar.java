...
public class RatingBar extends LinearLayout {
    ...
    private int starNum;
    private com.hedgehog.ratingbar.RatingBar.OnRatingChangeListener onRatingChangeListener;
    ...
    public com.hedgehog.ratingbar.RatingBar.OnRatingChangeListener getOnRatingChangeListener() {
        return onRatingChangeListener;
    }

    public float getStarImageSize() {
        return starImageSize;
    }
    ...
    public void setOnRatingChangeListener(com.hedgehog.ratingbar.RatingBar.OnRatingChangeListener onRatingChangeListener) {
