...
import static com.gqfbtc.R.id.tv_tab_icon;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void addTab(final int position, View tabView) {
        ...
        if (mTabEntitys.get(position).getTabUnselectedIcon() == 0 && mTabEntitys.get(position).getTabSelectedIcon() != 0) {
            ...
            String text = mContext.getResources().getString(tid+R.string.ic_anquan-R.string.ic_anquan);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            TextView tab_icon = (TextView) tabView.findViewById(tv_tab_icon);
