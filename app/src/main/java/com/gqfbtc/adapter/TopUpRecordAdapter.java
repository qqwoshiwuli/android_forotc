...
public class TopUpRecordAdapter extends CommonAdapter<TopUp> {
    ...
    public TopUpRecordAdapter(Context context, List<TopUp> datas) {
        super(context, R.layout.adapter_record, datas);
    }

    @Override
    protected void convert(ViewHolder holder, TopUp s, final int position) {
