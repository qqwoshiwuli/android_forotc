...
public class SaveLogService extends Service {
    ...
    public static final String KILL_LOGCAT_ACTION = "com.gqf.action.kill_logcat";
    public static final String START_LOGCAT_ACTION = "com.gqf.action.start_logcat";
    ...
    private void startSaveLog() {
        try {
            if (checkLogFolder())
                logFilePath = logFoldPath + "/HH-FOROTC" + new SimpleDateFormat("yyyyMMddHHmmss").format(Calendar.getInstance().getTime()) + ".log";
