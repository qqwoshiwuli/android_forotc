...
public class ResultDialog {
    ...
    public ResultDialogEntity ShowResultDialog(FragmentActivity activity, String data, DefaultClickLinsener defaultClickLinsener) {
        if (!TextUtils.isEmpty(data)) {
            ...
            if ("1".equals(resultDialogEntity.getType())) {
                ...
                ToastUtil.show(resultDialogEntity.getTitle());
    ...
    private CircleDialog.Builder initAlertDialog(FragmentActivity activity, final ResultDialogEntity resultDialogEntity, final DefaultClickLinsener defaultClickLinsener) {
                ...
                .configText(new ConfigText() {
                    ...
                    public void onConfig(TextParams params) {
                        if (!TextUtils.isEmpty(resultDialogEntity.getContent())) {
                            ...
                            params.padding = new int[]{50, TextUtils.isEmpty(resultDialogEntity.getContent()) ? 50 : 0, 50, 50};
                        } else {
                            params.padding = new int[]{0, 0, 0, 0};
                        }
                    }
                });
        builder.setWidth(0.7f)
                .setPositive(TextUtils.isEmpty(resultDialogEntity.getConfirmBtn()) ? "确定" : resultDialogEntity.getConfirmBtn(), new View.OnClickListener() {
                    @Override
    ...
    private CircleDialog.Builder initConfirmDialog(FragmentActivity activity, final ResultDialogEntity resultDialogEntity, final DefaultClickLinsener defaultClickLinsener) {
        CircleDialog.Builder builder = new CircleDialog.Builder(activity);
        if (!TextUtils.isEmpty(resultDialogEntity.getContent())) {
            builder.setTitle(resultDialogEntity.getTitle())
                    .configTitle(new ConfigTitle() {
        ...
        builder.setWidth(0.7f)
                ...
                .setNegative(TextUtils.isEmpty(resultDialogEntity.getCancelBtn()) ? "取消" : resultDialogEntity.getCancelBtn(), new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
