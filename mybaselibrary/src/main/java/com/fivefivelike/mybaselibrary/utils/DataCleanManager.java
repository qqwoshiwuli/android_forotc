...
//                cacheSize+= getFolderSize(FileUtil.getCropFileDir(mContext));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//            deleteDir(FileUtil.getCropFileDir(mContext));
        }
    }
    ...
    public static boolean deleteDir(File dir) {
        ...
        //删除完后扫描文件夹,更新媒体库,避免删除图片留下了空白图片
        MediaScannerConnection.scanFile(GlobleContext.getInstance().getApplicationContext(), new String[]{dir.getAbsolutePath()}, null, null);
        return dir.delete();
    }
